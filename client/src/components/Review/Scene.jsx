        ...
        >
            ...
            >
                ...
                <Suspense fallback={null}>
                    ...
                    {zoneToolActive && zoneDrawing && (
                        <mesh
                            position={[
                                (zoneDrawing.start.x + zoneDrawing.current.x) / 2,
                                0.06,
                                (zoneDrawing.start.z + zoneDrawing.current.z) / 2,
                            ]}
                            rotation={[-Math.PI / 2, 0, 0]}
                        >
                            <planeGeometry
                                args={[
                                    Math.abs(zoneDrawing.current.x - zoneDrawing.start.x),
                                    Math.abs(zoneDrawing.current.z - zoneDrawing.start.z),
                                ]}
                            />
            ...
            <ZoneTool apiUrl={warehouseApiUrl} />
        </div>
    );
};
